		...
		<div class="container">
			...
			<div class="row">
								...
								<div class="product product-style-3 equal-elem ">
									<div class="product-thumnail">
										<a href="detail.html" title="{{ $pro->name }}">
											<figure><img src="{{ asset('productimages/'.$pro->image) }}" alt="{{ $pro->name }}"></figure>
										</a>
									</div>
									<div class="product-info">
										<a href="#" class="product-name"><span>{{ $pro->name }}</span></a>
										<div class="wrap-price"><span class="product-price">{{ $pro->price }}</span></div>
										<a href="{{ route('addtocart', $pro->id) }}" class="btn add-to-cart">Add To Cart</a>
									</div>
								</div>
							</li>
                            @endforeach
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
						...
						<div class="widget-content">
							<ul class="list-category">
                                ...
                                <li class="category-item">
									<a href="{{ route('filterbycategory', $cat->slug) }}" class="cate-link">{{ $cat->name }}</a>
								</li>
                                @endforeach
                    ...
                    <!-- br{{ $cats[0]->name }}div class="widget mercado-widget filter-widget price-filter">
